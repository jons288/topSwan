#' Define Log 10 Y-axis with proper grid settings and labels
#'
#' @param ... Arguments to be passed to the scale_y_log10 ggplot2 function
#'
#' @return Log 10 Y-axis with proper grid settings and labels
#' @export
#' @import ggplot2
#'
#' @examples
scale_y_logTen <- function(...) {
  ...
  ret <- ggplot2::scale_y_log10(minor_breaks = minor_breaks_log(10),
